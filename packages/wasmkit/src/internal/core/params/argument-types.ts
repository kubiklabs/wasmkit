...
export interface ArgumentType<T> {
  ...
  /**
   * Parses strValue. This function MUST throw WASMKIT301 if it
   ...
   *
   * @throws WASMKIT301 if an invalid value is given.
   ...
   *
   * @throws WASMKIT301 if value is not of type <t>
   */
...
export const string: ArgumentType<string> = {
   ...
   *
   * @throws WASMKIT301 if value is not of type "string"
   */
  validate: (argName: string, value: any): void => {  // eslint-disable-line
    const isString = typeof value === "string";

    if (!isString) {
      throw new WasmkitError(ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE, {
        value,
        name: argName,
        type: string.name
      });
...
export const boolean: ArgumentType<boolean> = {
   ...
   * @param value {any} argument's value to validate.
   *
   * @throws WASMKIT301 if value is not of type "boolean"
   */
...
export const int: ArgumentType<number> = {
   ...
   * @param value {any} argument's value to validate.
   *
   * @throws WASMKIT301 if value is not of type "int"
   */
  validate: (argName: string, value: any): void => {  // eslint-disable-line
...
export const float: ArgumentType<number> = {
   ...
   * @param value {any} argument's value to validate.
   *
   * @throws WASMKIT301 if value is not of type "number"
   */
  validate: (argName: string, value: any): void => {  // eslint-disable-line
...
export const inputFile: ArgumentType<string> = {
   ...
   * @param value {any} argument's value to validate.
   *
   * @throws WASMKIT301 if value is not of type "inputFile"
   */
  validate: (argName: string, value: any): void => {  // eslint-disable-line
    try {
...
export const json: ArgumentType<any> = {  // eslint-disable-line
   ...
   * @param value {any} argument's value to validate.
   *
   * @throws WASMKIT301 if value is not of type "json"
   */
  validate: (argName: string, value: any): void => { // eslint-disable-line @typescript-eslint/no-explicit-any
    if (value === undefined) {
      throw new WasmkitError(ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE, {
