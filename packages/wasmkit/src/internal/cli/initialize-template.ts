...
/**
 * Ensures that the template passed by user exists in arufa-research/wasmkit-templates,
...
/**
 * Initialize a template from 'arufa-research/wasmkit-templates' with given name
 * and destination
 * @param force --force flag. If true then contents in destination directory are overwritten
 * @param templateName templateName to initialize from arufa-research/wasmkit-templates.
